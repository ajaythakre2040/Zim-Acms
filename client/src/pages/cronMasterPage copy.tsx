...
export default function DynamicCronDashboard() {
    ...
    const fields: FieldConfig[] = [
        ...
        {
            key: "scheduleTime", // Humne key change kar di
            label: "Sync Interval (Seconds)",
            required: true,
            type: "number", // Number input ban jayega
            placeholder: "e.g., 30 or 90",
            // description: "How often the task should run (in seconds).",
            // @ts-ignore
            validate: (value: number) => {
                if (value < 10) return "Interval must be at least 10 seconds for stability";
                return true;
            },
        },
        {
    ...
    return (
        <div className="p-4 md:p-8 max-w-[1500px] mx-auto space-y-6">
            ...
            <CrudDialog
                ...
                onSubmit={async (val) => {
                    const finalData = { ...val, group: val.code };
                    editing
