        ...
        },
        {
            ...
            render: (item: any) => {
                ...
                if (action === "EDIT" || action === "UPDATE") {
                    return <Badge className="bg-amber-100 text-amber-700 border-amber-300 hover:bg-amber-200 font-bold tracking-wide shadow-sm">UPDATE</Badge>;
                }
                if (action === "ADD/EDIT" || action === "CREATE/UPDATE") {
                    return <Badge className="bg-sky-100 text-sky-700 border-sky-300 hover:bg-sky-200 font-bold tracking-wide shadow-sm">ADD/UPDATE</Badge>;
                }
