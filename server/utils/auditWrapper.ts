...
export const withAudit = (
    tableName: TableNames,
    action: "ADD" | "UPDATE" | "DELETE" | "ADD/UPDATE" | "EMERGENCY_BLOCK" | "SINGLE_DOOR_EMERGENCY_UNLOCK" |"EMERGENCY_BLOCK_ALL"| "SINGLE_DOOR_REFRESH"| "EMERGENCY_UNBLOCK_ALL" | "BULK_EMPOYEE_UPDATE" | "BULK_DOOR_ASIGNMENT" | "BULK_CONTRACTOR_UPLOAD" |((req: any) => string),
